...
public:
    ...
    void run() {
        ...
        long long wifeSalary, husbandSalary, coupleIncome, otherIncome;
        cout << "Nhap luong vo hang thang: "; cin >> wifeSalary;
        cout << "Nhap luong chong hang thang: "; cin >> husbandSalary;
        cout << "Nhap thu nhap chung hai vo chong hang thang: "; cin >> coupleIncome;
        ...
        while (isRunning) {
            system("cls");
            //Income familyIncome(wifeSalary, husbandSalary, coupleIncome, otherIncome);
